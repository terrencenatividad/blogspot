...
<div class="import-modal" id="import-modal">
	...
	// linkButtonToTable('#activateMultipleBtn', '#supplier_table');
	// linkButtonToTable('#deactivateMultipleBtn', '#supplier_table');
	...
	linkDeleteMultipleToModal('#item_multiple_delete', '#supplier_table', 'ajaxCallback');
		...
		$('#supplier_table').on('click', '.activate', function() { 
			...
			$.post('<?=MODULE_URL?>ajax/ajax_edit_activate', '&partnercode='+activate_code ,function(data) {
				showList();
			});
		});
		var deactivate_code = '';
		$('#supplier_table').on('click', '.deactivate', function() { 
			...
			$('#deactivate_modal').on('click', '#deactyes', function() {
				...
				$.post('<?=MODULE_URL?>ajax/ajax_edit_deactivate', '&partnercode='+deactivate_code ,function(data) {
					showList();
				});
			});
		});
		...
		function historyOfMyLife() {
			var arr = [];
			$('#supplier_table tbody').find('.label').each(function(index, value){
				arr.push($(this).html());
