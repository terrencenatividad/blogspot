			...
			<thead>
				<?php
					echo $ui->loadElement('table')
							...
							->addHeader('IPO No.', array('class'=>'col-md-1'),'sort','po.voucherno','desc')
							...
							->addHeader('Balance',array('class'=>'col-md-2'),'sort','balance')
...
<script>
	...
	/** -- FOR DISPLAY -- end **/	
		function showList(){
			...
			ajax_call  	=	$.post('<?=BASE_URL?>purchase/import_purchaseorder/ajax/po_listing',ajax, function(data) {
