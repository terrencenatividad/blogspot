...
class payment_voucher_model extends wc_model
{
	...
	public function retrieveEditData($sid)
	{
		...
		// Retrieve Details
		$detailFields = "main.budgetcode, main.accountcode, chart.accountname, main.detailparticulars, main.ischeck, main.debit, main.credit credit, main.taxcode, main.taxbase_amount";
	...
	public function getBookNum($accountno){
		$result = $this->db->setTable("bank b")
		->setFields("bd.booknumber")
		->leftJoin('bankdetail as bd ON b.id = bd.bank_id')
		->setWhere("b.accountno = '$accountno' ")
		->runSelect()
		->getRow();
								// echo $this->db->getQuery();
		return $result; 
