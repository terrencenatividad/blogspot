					...
					<!-- <form class="navbar-form navbar-left">
						<div class="btn-group" id="option_buttons">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="" id="export_csv" download="Chart of Accounts.csv"><span class="glyphicon glyphicon-export"></span>Export Accounts</a></li>
		...
		<div class="panel panel-default">
			<div class="panel-heading" id="option_filter">
				<div class="row">
					...
					<!--<label class="control-label col-md-2 col-sm-2 col-xs-2 right" for="items" 
						style="padding-top:5px;">Display</label>-->
					<!--<div class="col-md-1 col-sm-1 col-xs-1">
						<select name="items" id="items" class="form-control" 
						false false  onChange="showList();" style="padding-left:5px; padding-right:5px;" >
						<option value="10" >10</option>
					...
					<table id="tableList" class="table table-striped table-condensed table-bordered table-hover">
						...
						<?
							echo $ui->loadElement('table')
								...
								->addHeader('Account Code', array('class' => 'col-md-2 text-center'), 
											'sort', 'chart.segment5', 'asc')
								->addHeader('Account Name', array('class' => 'col-md-5 text-center'), 
