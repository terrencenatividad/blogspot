        ...
        <div class = "panel panel-default">
            <div class = "panel-heading">
                <form class = "form-horizontal hidden" method="POST" id="receiptForm">
                    ...
                    <input value = "<?= $v_vendorcode ?>" name="vendor[1]" id="vendor[1]" type="hidden">
                    <input value = "accounts_payable" name="type" id="type" type="hidden">
                        ...
                        <div class="col-md-11">
                            <div class="row">
                                <div class="col-md-offset-1 col-md-5">
                                    <h4><strong>Account Payable : </strong><?=$v_voucherno?></h4>
                                </div>
                                <div class="col-md-6">
                                <?php
            ...
            <div class = "panel-body">
                <div class = "row">
                    <div class="col-md-8 col-sm-8 col-xs-8">
                        ...
                        <h2>
                            <strong>Accounts Payable</strong> <small><?='('.$v_voucherno.')'?></small>
                        </h2>
                    </div>
                ...
                <div class = "row">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-8 text-center">
                        <?if(false && $v_balance > 0 && $restrict_ap && $stat != 'cancelled'){?>
                        <button type="button" class="btn btn-primary btn-md btn-flat" id="btnReceive">Issue Payment</button>
                        &nbsp;
                        <?}?>
                        
                        <?if(empty($data["payments"]) && $data['checker'] != "import" && $restrict_ap && $stat != 'cancelled'){?>
                        <a href="<?=BASE_URL?>financials/accounts_payable/edit/<?=$sid?>" class="btn btn-primary btn-md btn-flat">Edit</a>
                        <?}?>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-2 text-right">
                        <a href="<?=BASE_URL?>financials/accounts_payable" role="button" class="btn btn-primary btn-md btn-flat" id="btnExit" >Exit</a>
                    </div>
                </div>
                ...
                <!--CHEQUE DETAILS
                <div id="chq_div" class = "panel panel-default hidden">
                    <div class="panel-heading">
...
$(document).ready(function() 
{
    ...
    //var show_chq  = $('#show_chequedetails').val();

    if( show_pd == 1 ){
        $('#pd_div').removeClass('hidden');
    }
    // if( show_chq == 1 ){
    //     $('#chq_div').removeClass('hidden');
    // }
