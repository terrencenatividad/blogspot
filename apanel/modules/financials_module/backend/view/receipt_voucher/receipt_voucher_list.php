				...
				<table id="tableList" class="table table-hover table-bordered table-striped">
					<?php
						echo $ui->loadElement('table')
								...
								->addHeader('OR NO', array('class' => 'col-md-3'), 'sort', 'main.or_no')
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form method="POST" id="importForm" ENCTYPE="multipart/form-data">
					...
					<div class="modal-body">
						<label>Step 1. Download the sample template <a href="<?=BASE_URL?>modules/financials_module/backend/view/pdf/import_receipt_voucher.csv">here</a></label>
						<hr/>
...
<script>
	...
	ajaxToFilter(ajax, { search : '#table_search', limit : '#items', vendor : '#customer', daterangefilter : '#daterangefilter' });
...
function showList() 
{
	ajax_call = $.post('<?=BASE_URL?>financials/receipt_voucher/ajax/load_list', ajax, function(data)
	{
