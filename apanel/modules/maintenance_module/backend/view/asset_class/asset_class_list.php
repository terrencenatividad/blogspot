				...
				<table id="tableList" class="table table-hover">
					<?php
						echo $ui->loadElement('table')
								...
								->addHeader('Code', array('class'=>'col-md-2'),'sort','code')
								->addHeader('Asset Class',array('class'=>'col-md-2'),'sort','assetclass')
								->addHeader('GL Account(Asset)', array('class'=>'col-md-3'),'sort','gl_asset')
								->addHeader('GL Account(Acc Dep)', array('class'=>'col-md-3'),'sort','gl_accdep')
								->addHeader('GL Account(Depreciation Expense)', array('class'=>'col-md-3'),'sort','gl_depexpense')
