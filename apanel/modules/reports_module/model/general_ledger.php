<?php
    ...
    {        
		...
		public function retrieveAllAccounts($acctcode, $startdate, $enddate, $search, $sort) {
			...
			$fields 	=	 array('bal.accountcode, bal.transactiondate, bal.voucherno, p.partnername as partner ,  ca.accountname, ca.segment5 as segment5,bal.period, bal.fiscalyear, bal.transtype, SUM(bal.debit) as debit, SUM(bal.credit) as credit');
