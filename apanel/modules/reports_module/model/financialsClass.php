	...
	{ 
		...
		$journal_select_query = $this->db->setTable("journaldetails as dtl")
					->setFields(array("dtl.companycode","dtl.accountcode","dtl.voucherno","hdr.transtype",
						  "dtl.linenum","hdr.transactiondate","hdr.period","hdr.fiscalyear",
		...
		->setFields(array("companycode","accountcode","voucherno","transtype","linenum","transactiondate","period","fiscalyear","debit","credit"))
