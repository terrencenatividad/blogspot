...
class print_bir_2550Q extends fpdf {
	...
	private function drawDocumentDetails() {
		...
		if($documentInfo){
			...
			$totalsalesA			= isset($documentInfo['totalsalesA']) ? urldecode($documentInfo['totalsalesA']) : "0.00";
			$totalsalesB			= isset($documentInfo['totalsalesB']) ? urldecode($documentInfo['totalsalesB']) : "0.00";
		...
		$this->SetY(66);
		$this->SetX(149);
		$this->Cell(5, 19, $vat_privateA, 0, 0, 'R');
		$this->SetX(202);
		$this->Cell(5, 19, $vat_privateA, 0, 0, 'R');
		$this->SetY(69);
		$this->SetX(149);
		$this->Cell(5, 19, $vat_govA, 0, 0, 'R');
		$this->SetX(202);
		$this->Cell(5, 19, $vat_govB, 0, 0, 'R');
		$this->SetY(72);
		$this->SetX(149);
		$this->Cell(5, 19, $vat_zero, 0, 0, 'R');
		$this->SetY(75.5);
		$this->SetX(149);
		$this->Cell(5, 19, $vat_exempt, 0, 0, 'R');
		$this->SetY(78.5);
		$this->SetX(149);
		$this->Cell(5, 19, $totalsalesA, 0, 0, 'R');
		$this->SetX(202);
		$this->Cell(5, 19, $totalsalesB, 0, 0, 'R');
		$this->SetY(84.5);
		$this->SetX(202);
		$this->Cell(5, 19, $carriedover20A, 0, 0, 'R');
		$this->SetY(88);
		$this->SetX(202);
		$this->Cell(5, 19, $deferred20B, 0, 0, 'R');
		$this->SetY(91.5);
		$this->SetX(202);
		$this->Cell(5, 19, $transitionalinputtax20C, 0, 0, 'R');
		$this->SetY(94.5);
		$this->SetX(202);
		$this->Cell(5, 19, $presumptiveinputtax26D, 0, 0, 'R');
		$this->SetY(98);
		$this->SetX(202);
		$this->Cell(5, 19, $others20E, 0, 0, 'R');
		$this->SetY(101);
		$this->SetX(202);
		$this->Cell(5, 19, $totalsum20F, 0, 0, 'R');

		$this->SetY(107);
		$this->SetX(149);
		$this->Cell(5, 19, $cgnotexceed21A, 0, 0, 'R');
		$this->SetY(107);
		$this->SetX(202);
		$this->Cell(5, 19, $cgnotexceed21B, 0, 0, 'R');
		$this->SetY(110.5);
		$this->SetX(149);
		$this->Cell(5, 19, $cgexceed21C, 0, 0, 'R');
		$this->SetY(110.5);
		$this->SetX(202);
		$this->Cell(5, 19, $cgexceed21D, 0, 0, 'R');
		$this->SetY(113.5);
		$this->SetX(149);
		$this->Cell(5, 19, $dompurchase21E, 0, 0, 'R');
		$this->SetY(113.5);
		$this->SetX(202);
		$this->Cell(5, 19, $dompurchase21F, 0, 0, 'R');
		$this->SetY(116.5);
		$this->SetX(149);
		$this->Cell(5, 19, $importation21G, 0, 0, 'R');
		$this->SetY(116.5);
		$this->SetX(202);
		$this->Cell(5, 19, $importation21H, 0, 0, 'R');
		$this->SetY(120);
		$this->SetX(149);
		$this->Cell(5, 19, $dompurchaseserv21I, 0, 0, 'R');
		$this->SetY(120);
		$this->SetX(202);
		$this->Cell(5, 19, $dompurchaseserv21J, 0, 0, 'R');
		$this->SetY(123);
		$this->SetX(149);
		$this->Cell(5, 19, $servicerenderedK, 0, 0, 'R');
		$this->SetY(123);
		$this->SetX(202);
		$this->Cell(5, 19, $servicerenderedL, 0, 0, 'R');
		$this->SetY(126);
		$this->SetX(149);
		$this->Cell(5, 19, $purchasenotqualified21M, 0, 0, 'R');
		$this->SetY(130);
		$this->SetX(149);
		$this->Cell(5, 19, $others21N, 0, 0, 'R');
		$this->SetY(130);
		$this->SetX(202);
		$this->Cell(5, 19, $others2O, 0, 0, 'R');
		$this->SetY(133);
		$this->SetX(149);
		$this->Cell(5, 19, $totalpurchases21P, 0, 0, 'R');
		$this->SetY(136);
		$this->SetX(202);
		$this->Cell(5, 19, $total22, 0, 0, 'R');
		$this->SetY(145.5);
		$this->SetX(202);
		$this->Cell(5, 19, $totalavailableinputtax23A, 0, 0, 'R');
		$this->SetY(148.5);
		$this->SetX(202);
		$this->Cell(5, 19, $totalavailableinputtax23B, 0, 0, 'R');
		$this->SetY(152);
		$this->SetX(202);
		$this->Cell(5, 19, $taxallocable23C, 0, 0, 'R');
		$this->SetY(155);
		$this->SetX(202);
		$this->Cell(5, 19, $vatrefund23D, 0, 0, 'R');
		$this->SetY(158);
		$this->SetX(202);
		$this->Cell(5, 19, $other23E, 0, 0, 'R');
		$this->SetY(161);
		$this->SetX(202);
		$this->Cell(5, 19, $total23F, 0, 0, 'R');
		$this->SetY(164.5);
		$this->SetX(202);
		$this->Cell(5, 19, $totalallowableinputtax24, 0, 0, 'R');
		$this->SetY(168);
		$this->SetX(202);
		$this->Cell(5, 19, $netpayable25, 0, 0, 'R');
		$this->SetY(174.5);
		$this->SetX(202);
		$this->Cell(5, 19, $monthlyvat26A, 0, 0, 'R');
		$this->SetY(177.5);
		$this->SetX(202);
		$this->Cell(5, 19, $creditablevat26B, 0, 0, 'R');
		$this->SetY(180.5);
		$this->SetX(202);
		$this->Cell(5, 19, $sugarandflour26C, 0, 0, 'R');
		$this->SetY(184);
		$this->SetX(202);
		$this->Cell(5, 19, $inputtaxsale26D, 0, 0, 'R');
		$this->SetY(187);
		$this->SetX(202);
		$this->Cell(5, 19, $vatpaid26E, 0, 0, 'R');
		$this->SetY(190);
		$this->SetX(202);
		$this->Cell(5, 19, $advpaymentsmade26F, 0, 0, 'R');
		$this->SetY(193);
		$this->SetX(202);
		$this->Cell(5, 19, $otherstaxcredits26G, 0, 0, 'R');
		$this->SetY(196.5);
		$this->SetX(202);
		$this->Cell(5, 19, $totaltaxcredits26H, 0, 0, 'R');
		$this->SetY(199.5);
		$this->SetX(202);
		$this->Cell(5, 19, $taxstillpayable27, 0, 0, 'R');
