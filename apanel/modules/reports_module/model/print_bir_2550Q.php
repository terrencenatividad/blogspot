...
class print_bir_2550Q extends fpdf {
	...
	private function drawDocumentDetails() {
		...
		if($documentInfo){
			...
			$signatory_name 		= isset($documentInfo['signatory_name']) ? $documentInfo['signatory_name'] : "";
			$signatory_name 		= strtoupper(urldecode($signatory_name));
		...
		$this->SetX(53);
		// $array = str_split($signatory_name);
		$this->Cell(5, 20, $signatory_name, 0, 0, 'C');
		...
		$this->SetY(116.5);
		$this->SetX(149);
		$this->Cell(5, 19, number_format(str_replace(',','',$importation21G),2), 0, 0, 'R');
		$this->SetY(116.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$importation21H),2), 0, 0, 'R');
		$this->SetY(120);
		$this->SetX(149);
		...
		$this->SetY(136);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$total22),2), 0, 0, 'R');
		$this->SetY(145.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$totalavailableinputtax23A),2), 0, 0, 'R');
		$this->SetY(148.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$totalavailableinputtax23B),2), 0, 0, 'R');
		$this->SetY(152);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$taxallocable23C),2), 0, 0, 'R');
		$this->SetY(155);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$vatrefund23D),2), 0, 0, 'R');
		$this->SetY(158);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$other23E),2), 0, 0, 'R');
		$this->SetY(161);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$total23F),2), 0, 0, 'R');
		$this->SetY(164.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$totalallowableinputtax24),2), 0, 0, 'R');
		$this->SetY(168);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$netpayable25),2), 0, 0, 'R');
		$this->SetY(174.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$monthlyvat26A),2), 0, 0, 'R');
		$this->SetY(177.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$creditablevat26B),2), 0, 0, 'R');
		$this->SetY(180.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$sugarandflour26C),2), 0, 0, 'R');
		$this->SetY(184);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$inputtaxsale26D),2), 0, 0, 'R');
		$this->SetY(187);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$vatpaid26E),2), 0, 0, 'R');
		$this->SetY(190);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$advpaymentsmade26F),2), 0, 0, 'R');
		$this->SetY(193);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$otherstaxcredits26G),2), 0, 0, 'R');
		$this->SetY(196.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$totaltaxcredits26H),2), 0, 0, 'R');
		$this->SetY(199.5);
		$this->SetX(202);
		$this->Cell(5, 19, number_format(str_replace(',','',$taxstillpayable27),2), 0, 0, 'R');
