...
class controller extends wc_controller {
	...
	public function __construct() {
		...
		$this->ar_transaction	= new ar_transaction();
	...
	private function load_customer_list()
	{
		...
		$pagination = $this->ar_transaction->getCustomerList($data_post);
	...
	private function load_voucher_list(){
		...
		$pagination = $this->ar_transaction->getVoucherList($data_post);
		$tablerow = "";
	...
	private function ajax_list()
	{
		...
		$pagination = $this->ar_transaction->getInvoiceList($data_post);
	...
	private function export()
	{
		...
		$retrieved = $this->ar_transaction->fileExport($data);
