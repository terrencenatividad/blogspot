...
class controller extends wc_controller {
	...
	private function ajax_list() {
		...
		$pagination		= $this->ar_aging->getArAging($datefilter, $customer);
		$total_aging	= $this->ar_aging->getArAgingTotal($datefilter, $customer);
		...
		foreach ($pagination->result as $key => $row) {
			...
			$table .= '<td><a href="'.BASE_URL."financials/accounts_receivable/view/" . $row->voucherno . '" target="_blank">'. $row->voucherno . '</a></td>';
	...
	private function get_export() {
		...
		$result			= $this->ar_aging->getArAgingExport($datefilter, $customer);
		$total_aging	= $this->ar_aging->getArAgingTotal($datefilter, $customer);
