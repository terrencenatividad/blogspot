    ...
    <div class="box box-primary">
		<form method = "post">
			...
			<div class="box-header">
				<div class="row">
					<div class = "col-md-8">
						<a class="btn btn-primary btn-flat" role="button" href="<?=BASE_URL?>sales/sales_order/create" style="outline:none;">Create New Sales Order</a>
						<button type="button" id="item_multiple_delete" class="btn btn-danger delete_button">Cancel<span></span></button>
						<!--<a href="" id="export_csv" download="Sales Order.csv" class="btn btn-info btn-flat"><span class="glyphicon glyphicon-export"></span> CSV</a>-->
					</div>
					<div class = "col-md-4">
