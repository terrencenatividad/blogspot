<section class="content">
				...
				<div class="row">
					<div class="col-md-8">
						<div class="form-group">
							<a href="<?= MODULE_URL ?>create" class="btn btn-primary">Create Packing List</a>
		...
		<div class="nav-tabs-custom">
			<ul id="filter_tabs" class="nav nav-tabs">
				...
				<li><a href="Packed" data-toggle="tab">Packed</a></li>
				<li><a href="Delivered" data-toggle="tab">Closed</a></li>
				...
				<table id="tableList" class="table table-hover table-sidepad">
					<?php
						echo $ui->loadElement('table')
								...
								->addHeader('Packing No.', array('class' => 'col-md-3'), 'sort', 'voucherno', 'desc')
								->addHeader('Supplier', array('class' => 'col-md-2'), 'sort', 'customer')
