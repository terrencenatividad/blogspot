...
class controller extends wc_controller {
	...
	public function listing() {
		...
		$data['ui']				= $this->ui;
		$this->view->load('return/return_list', $data);
	}

	public function create() {
		$this->view->title			= 'Create Return';
		$this->fields[]				= 'stat';
	...
	private function ajax_list() {
		...
		$pagination	= $this->sales_model->getReturnPagination($search, $sort, $customer, $filter, $datefilter);
		$table		= '';
	...
	private function ajax_create() {
		...
		$result						= $this->sales_model->saveReturn($data, $data2);
	...
	private function ajax_load_invoice_list() {
		...
		$pagination	= $this->sales_model->getSalesReturnPagination($customer, $search);
		$table		= '';
		if (empty($pagination->result)) {
			$table = '<tr><td colspan="9" class="text-center"><b>No Records Found</b></td></tr>';
		}
	...
	private function ajax_load_invoice_details() {
		...
		$details	= $this->sales_model->getSalesReturnDetails($voucherno);
		$header		= $this->sales_model->getSalesReturnHeader($this->fields_header, $voucherno);
		$table		= '';
		$success	= true;
		if (empty($details)) {
			$table		= '<tr><td colspan="9" class="text-center"><b>No Records Found</b></td></tr>';
